...
<div class="wrapper col4">
    ...
    <script>
        ...
        function SearchPokemon (e) {
            ...
            .then(function (response) {
                ...
                const contentHTML = 
                `<div>
                    <center><img  style="width: 150px" src="${data.sprites.front_default}">
                    <center><img  style="width: 150px" src="${data.sprites.back_default}">
                </div>
                <h3 style="text-align: center; margin-bottom: 20px">Pokemon ${data.name}</h3>
                <div>
                    <ul style="font-size: 18px">
    ...
    @if ($index->count())
      <ul id="latestnews">
        ...
        <li class="last"><img src="{{$index[5]->img_url}}" alt="" width ="290" height="200">
